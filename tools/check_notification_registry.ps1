# Query notification settings for noticeWindowFinder AUMID(s)
...
Write-Output "Looking for keys matching 'noticeWindowFinder' under $base"
Get-ChildItem -Path $base | Where-Object { $_.Name -match 'noticeWindowFinder' } | ForEach-Object {
    Write-Output "---"
